...
一個整合了Bedrock Chat Telegram (https://github.com/aws-samples/bedrock-chat)聊天機器人，透過 [bedrock-chat] API 提供智能對話功能。
